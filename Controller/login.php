...
//            $Pronosticos->getPronostico()
            ...
            echo strtoupper($username).", Tienes <b>".$myArray[0]->getPronostico()."</b> puntos acumulados";
            break;
        ...
        default:
            ...
            $n = new NickName();
            $class = $n->getByFilter(array('Nick'=> mysql_real_escape_string($nick), 'PWD'=>  mysql_real_escape_string(md5($pass)), 'Pago'=>'1'));
            if ($class===FALSE){
